...
const CustomSidebarMenu = ({props, user}) => {
  ...
  // console.log(user, "the user sending to other screens  is not available from others screen")
 ...
 * */   
  return (
    <SafeAreaView style={{flex:1}}>
      ...
      />
      <Text style={{fontFamily:"Plus Jakarta Sans", alignSelf:"center", fontWeight:"bold", color:"rgb(0, 0, 0)"}}>John Doe</Text>
      <DrawerContentScrollView {...props} user={user} >
        <DrawerItemList {...props} user={user}/>
      ...
      colors={['skyblue','rgba(239, 172, 50, 0.05)','#F0BF62']} style={{ width:"90%", height:"90%", alignSelf:"center", borderRadius:20, borderWidth:1, borderColor:"rgb(239, 172, 50)"}} >
                <View style={{flexDirection:"column", marginHorizontal:"9%", marginVertical:"8%"}}>
                        <View style={{flexDirection:"row"}}>
                            ...
                            <Text style={{fontFamily:"Plus Jakarta Sans", fontSize:20, fontWeight:"bold", color:"rgb(0,0,0)", marginVertical:"-2%", marginHorizontal:"3%"}}>Announcement</Text>
                        </View>
                        <View style={{width:"85%"}}>
                            <Text style={{fontFamily:"Plus Jakarta Sans", color:"rgb(0,0,0)",}}>
