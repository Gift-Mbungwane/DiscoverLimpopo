       ...
       <Modal
        ...
        >
          <View style={styles.modalView}>
            <TouchableOpacity activeOpacity={0.5} style={{width:"50%", height:"30%", borderRadius:300, }}>
                    <Image source={require('../../assets/images/John-Doe.jpg')} style={styles.image} />
        ...
        <View style={{width:"95%", backgroundColor:'rgba(239, 172, 50, 0.05)', borderRadius:30, flexDirection:"row", marginVertical:"3%", height:50,marginHorizontal:"2%", justifyContent:"space-between", alignContent:"center", alignItems:"center"}}>
         ...
         <Text style={{fontSize:34,fontFamily:"Plus Jakarta Sans", color:"#FFFFFF", fontWeight:"bold", marginHorizontal:"5%", marginVertical:"-1%", width:"80%"}}>Profile Details</Text>
        </View>
        <View style={{flex:3, flexDirection:"column"}}>
            <View style={{flexDirection:"row", width:"90%", marginVertical:"5%", marginHorizontal:"4%"}}>
              ...
              <View style={{marginHorizontal:"3%", marginVertical:"7%"}}>
                <Text style={{fontSize:14, color:"grey",fontFamily:"Plus Jakarta Sans", fontWeight:"bold",}}>Display Name</Text>
                <Text style={{fontSize:18, color:"rgb(0,0,0)", fontWeight:"500",fontFamily:"Plus Jakarta Sans", marginVertical:"1%"}}>Gift Doe</Text>
              </View>
            </View>
            <View style={{marginHorizontal:"4%", marginVertical:"-3%"}}>
                <Text style={{fontSize:14, color:"grey",fontFamily:"Plus Jakarta Sans", fontWeight:"bold",}}>Name</Text>
                <Text style={{fontSize:18, color:"rgb(0,0,0)",fontFamily:"Plus Jakarta Sans", fontWeight:"500", marginVertical:"1%"}}>Gift</Text>
              </View>
              <View style={{marginHorizontal:"4%", marginVertical:"3%"}}>
                <Text style={{fontSize:14, color:"grey",fontFamily:"Plus Jakarta Sans", fontWeight:"bold",}}>Email Address</Text>
              ...
              <View style={{marginHorizontal:"4%", marginVertical:"2%"}}>
                <Text style={{fontSize:14, color:"grey",fontFamily:"Plus Jakarta Sans", fontWeight:"bold",}}>Phone Number</Text>
                <Text style={{fontSize:18, color:"rgb(0,0,0)",fontFamily:"Plus Jakarta Sans", fontWeight:"500", marginVertical:"1%"}}>0321456987</Text>
              </View>
              <View style={{marginHorizontal:"4%", marginVertical:"0%"}}>
                <Text style={{fontSize:14, color:"grey",fontFamily:"Plus Jakarta Sans", fontWeight:"bold",}}>Date of Birth</Text>
                <Text style={{fontSize:18, color:"rgb(0,0,0)", fontWeight:"500", marginVertical:"1%"}}>27 Jul, 2022</Text>
              </View>
              <View style={{marginHorizontal:"4%", marginVertical:"0%"}}>
                <Text style={{fontSize:14, color:"grey",fontFamily:"Plus Jakarta Sans", fontWeight:"bold",}}>Nationality</Text>
                <Text style={{fontSize:18, color:"rgb(0,0,0)", fontWeight:"500",fontFamily:"Plus Jakarta Sans", marginVertical:"1%"}}>South African</Text>
              </View>
        </View>
        ...
        <View style={{ width:"100%"}}>
          ...
          activeOpacity={1}
           style={{borderColor:"rgb(239, 172, 50)", borderWidth:1, width:"90%", height:40, alignSelf:"center", marginVertical:"5%", borderRadius:30, alignItems:"center", justifyContent:"center"}}>
            <Text style={{fontSize:14, color:"rgb(239, 172, 50)",fontFamily:"Plus Jakarta Sans", fontWeight:"500"}}>
              EDIT PROFILE
            </Text>
          </TouchableOpacity>
        </View>
